...
import WalletTransactionsScreen from '../screens/subscription/WalletTransactionsScreen';
...
import CorporatePurchaseScreen from '../screens/subscription/CorporatePurchaseScreen';
import CorporateAutoOrderScreen from '../screens/subscription/CorporateAutoOrderScreen';
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <Stack.Screen name="CorporatePurchase" component={CorporatePurchaseScreen} />
        <Stack.Screen name="CorporateAutoOrder" component={CorporateAutoOrderScreen} />
